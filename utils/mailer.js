...
/**
 * This gets and store new token after prompting for user authorization, and then
...
/**
 * This create an OAuth2 client with the given credentials, and then execute the
...
/**
 * This delivers a mail through the user's account.
