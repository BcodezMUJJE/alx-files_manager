...
/**
 * This fetches the user from the Authorization header in the given request object.
...
/**
 * This fetches the user from the X-Token header in the given request object.
 * @param {Request} req The Express request object.
 * @returns {Promise<{_id: ObjectId, email: string, password: string}>}
 */
